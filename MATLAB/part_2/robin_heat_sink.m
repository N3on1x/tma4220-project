% Note: Relative paths are used to load the mesh, so the MATLAB directory
% need to be the folder with this file.
...
for i = 1:length(edge_r)
    ...
    z = @(x,y) (dot(nv,pt(1,:))-nv(1)*x-nv(2)*y)/nv(3); % Equation of the plane
